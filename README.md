...
2、让你的数据**model**继承**RecyclerBaseModel**，设置**Model**的**LayoutId**(很重要)，这样**model**就会通过**CommonRecyclerManager**，找到**LayoutId**对应关联的**Holder**，并生成它。

3、你需要一个**CommonRecyclerManager**来绑定你的**LayoutId**和处理这布局的**Holder**类名。

4、通过**CommonRecyclerManager**和**Model**的数据列表生成**CommonRecyclerAdapter**

5、把**Adapter**交给Recycler。

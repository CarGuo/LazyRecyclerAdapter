...
import com.shuyu.apprecycler.bind.view.BindHorizontalCustomLoadMoreFooter;
import com.shuyu.apprecycler.bind.view.BindHorizontalCustomRefreshHeader;
 ...
 */
public class BindHorizontalGridActivity extends AppCompatActivity {
    ...
    private void refresh() {
        List list = BindDataUtils.getRefreshImageData();
